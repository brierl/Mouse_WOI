function [I,seedcenter]=make_mask_seeds(frame5, mask_savename, seed_savename)
...
%   seed_savename: string filename for seed file e.g., 'seeds_mouse1'
...
%   seedcenter: mouse space seeds
    ...
    save([seed_savename '.mat'],'I', 'seedcenter');
    pause(0.5); close all;

end

function [I, seedcenter]=MakeSeedsMouseSpace(WL)
% make seeds for each mouse. Called by make_mask_seeds.m
