...
%   handle: figure handle (1xnum groups)
    ...
    for i=1:size(same,4) %loop through groups
        ...
        for d=1:length(oi.con_num) %loop through contrasts
                ...
                %plot avg values
                axes(ha(1+(d-1)*4));
                Im2=overlaymouse(same(:,:,d,i),WL, isbrain2_aff,'jet',-1,1,WL_factor);
                ...
                %plot std values
                axes(ha(2+(d-1)*4));
                Im2=overlaymouse(same_std(:,:,d,i),WL, isbrain2_aff,'jet',-1,1,WL_factor);
                imagesc(Im2(oi.plot_factor+1+WL_factor:end-oi.plot_factor,oi.plot_factor+1:end-oi.plot_factor,:));
                hold on;
                axis image off
                ...
                %plot avg values
                axes(ha(3+(d-1)*4));
                Im2=overlaymouse(opp(:,:,d,i),WL, isbrain2_aff,'jet',-1,1,WL_factor);
                imagesc(Im2(oi.plot_factor+1+WL_factor:end-oi.plot_factor,oi.plot_factor+1:end-oi.plot_factor,:));
                hold on;
                axis image off
                ...
                %plot std values
                axes(ha(4+(d-1)*4));
                Im2=overlaymouse(opp_std(:,:,d,i),WL, isbrain2_aff,'jet',-1,1,WL_factor);
                imagesc(Im2(oi.plot_factor+1+WL_factor:end-oi.plot_factor,oi.plot_factor+1:end-oi.plot_factor,:));
                hold on;
                axis image off
